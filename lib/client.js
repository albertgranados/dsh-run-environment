...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css =
			...
			'[role="menuitem"]:focus-visible .RUNENV_row,[role="menuitem"]:focus-visible .RUNENV_optionLabel{outline:2px solid var(--dsw-alias-label-primary);outline-offset:1px;border-radius:5px}';
		const styles = {
			split: 'RUNENV_split',
			main: 'RUNENV_main',
