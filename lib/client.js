...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			'console.goneBody': '它的输出随运行它的 harness 一起消失了。',
		...
		const en = {
			...
			'console.goneBody': 'Its output went with the harness that ran it.',
		...
		const es = {
			...
			'console.goneBody': 'Su salida se fue con el harness que lo ejecutó.',
